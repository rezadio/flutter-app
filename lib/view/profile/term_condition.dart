        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(children: [
                ...
                children: [
                  ...
                  RichText(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text:
                              " Syarat dan Ketentuan Layanan Aplikasi Eidupay",
                          style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.w400,
                              color: t100)),
                        ...
                        Flexible(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    'Untuk siswa setingkat SMP dan SMA (sederajat)',
                                style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w400,
                                    color: t70),
                        ...
                        Flexible(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    'PEMBELIAN/ISI ULANG DAN PEMBAYARAN TAGIHAN',
                                style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w400,
                                    color: t100),
                        ...
                        Flexible(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text:
                                    'KERJASAMA PIHAK KETIGA DALAM APLIKASI EIDUPAY',
                                style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w400,
                                    color: t100),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 0, top: 10),
                    child:
                        title('XIII.', 'INFORMASI DAN JALUR PENGADUAN RESMI'),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 35, top: 10),
                    child:
                        desc('-', 'Melalui email ke supprt@eidupay.com; atau'),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(left: 35, top: 10),
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(left: 25, top: 10, bottom: 40),
                    child: desc2(
              ...
              //SubmitButton(backgroundColor: green, text: 'Back', onPressed: ()=> Get.back(),)
            ]),
          ),
        ));
  }
